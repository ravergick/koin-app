        ...
        <div className="bg-white dark:bg-[#1C1C1E] rounded-[32px] p-6 border border-gray-100 dark:border-white/5 mb-6 animate-fade-in shadow-sm">
            ...
            <div className="flex items-center gap-6 mb-6">
                ...
                <div className="flex-1">
                    <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider mb-1">Total Ahorrado</h3>
                    <p className="text-2xl font-black text-emerald-500 tracking-tighter">${total.toLocaleString()}</p>
            ...
            <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-4 pl-1">Historial</h3>
            {transactions.length === 0 ? (
                <p className="text-center text-gray-400 text-xs py-4">Sin registros de ahorro</p>
            ) : (
